...
@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Ministral3RMSNorm_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
