...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.pixtral.modeling_pixtral import (Callable, Optional, torch, nn, ACT2FN, dynamic_rope_update, maybe_autocast, PixtralVisionConfig, __name__)
...
@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def PixtralRMSNorm_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
